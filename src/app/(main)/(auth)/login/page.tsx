    ...
    return (
        <AuthCard title="Welcome Back" subtitle="Sign in to your KNEX account">
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm sm:text-base active:scale-[0.99] transition cursor-pointer"
                >
